...
export const metadata: Metadata = {
  title: "LGPD | Vitrine Lojas",
  description:
    "Diretrizes de tratamento de dados pessoais e direitos do titular na plataforma Vitrine Lojas.",
};
...
const sections = [
  {
    ...
    paragraphs: [
      "A Vitrine Lojas trata dados pessoais em conformidade com a Lei Geral de Proteção de Dados Pessoais (Lei nº 13.709/2018), adotando medidas técnicas, administrativas e organizacionais compatíveis com a natureza da operação da plataforma.",
