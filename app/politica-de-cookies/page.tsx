...
export const metadata: Metadata = {
  ...
  description:
    "Diretrizes de uso de cookies para navegação, preferências, segurança e desempenho na Vitrine Lojas.",
};
...
const sections = [
  {
    ...
    paragraphs: [
      ...
      "Na Vitrine Lojas, eles ajudam a manter consistência de uso, reduzir fricção no fluxo e medir desempenho da plataforma.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "Esta política deve ser lida em conjunto com a Política de Privacidade, LGPD e Termos de Uso da Vitrine Lojas.",
      ...
      <section className="mx-auto max-w-5xl rounded-[2rem] border border-border bg-white p-8 shadow-sm lg:p-10">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-base leading-8 text-muted-strong">
            ...
            e análise de desempenho na plataforma Vitrine Lojas.
          </p>
        </div>
