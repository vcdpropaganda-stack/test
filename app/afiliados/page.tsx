...
export const metadata: Metadata = {
  title: "Afiliados | TESTE",
  description:
    "Landing page inicial do programa de afiliados da TESTE para captacao de parceiros e canais.",
};
      ...
      <section className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div>
          ...
          <h1 className="mt-6 max-w-3xl font-sans text-5xl font-bold tracking-tight text-slate-950">
            Indique prestadores e clientes para a TESTE e transforme alcance em
            receita recorrente.
          </h1>
