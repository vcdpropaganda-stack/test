...
export const metadata: Metadata = {
  title: "Termos | VLservice",
  description: "Termos de uso institucionais da plataforma VLservice.",
};
...
const sections = [
  {
    ...
    paragraphs: [
      "Ao acessar, navegar, cadastrar-se ou utilizar a VLservice, o usuário declara ciência e concordância com estes Termos de Uso e com as políticas complementares aplicáveis à plataforma.",
  ...
  },
  {
    ...
    paragraphs: [
      "A VLservice poderá alterar funcionalidades, layout, fluxos, preços, integrações, planos, políticas e termos a qualquer tempo, preservados os direitos legalmente exigíveis.",
