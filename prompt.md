...
Estamos desenvolvendo um marketplace de servicos locais chamado "VLservice". O objetivo e conectar clientes a prestadores de servicos, similar ao Workana ou 20pila. O projeto deve ser construido usando **Next.js (App Router), React, Tailwind CSS, TypeScript e Supabase** para o backend/banco de dados.
